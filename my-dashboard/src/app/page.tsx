...
<div className=" dashboard flex-1 ">
  ...
  <div className="Card-2 border p-6 rounded flex flex-col gap-2 justify-center items-center rounded-xl ">
    <span>Monthly Expenses</span>
    <span>67%</span>
  </div>
  <div className="Card-3 border p-6 rounded flex flex-col gap-2 justify-center items-center rounded-xl">
    <span>Savings</span>
    <span>$13,200</span>
  </div>
  </div>
  <div className="border p-9">Chart</div>
  <div className="border p-9  ">Table</div>
</div>
